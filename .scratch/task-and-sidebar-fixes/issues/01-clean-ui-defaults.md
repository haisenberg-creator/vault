# 01 — Clean UI Defaults

**What to build:** The task statuses in the editor toolbar no longer have raw markdown brackets, and the sidebar opens to the "Files & Folders" tab by default.
