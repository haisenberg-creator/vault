# 03 — Fix Subfolder Task Resolution

**What to build:** The Task Dashboard correctly resolves paths for notes inside folders, loading their actual contents (and progress) rather than displaying a blank "New Note".
